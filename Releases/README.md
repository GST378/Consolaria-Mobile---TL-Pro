...
Click on the file, then on the 3 dots and then on "Download", import the file into TL Pro and enable the mod in the resource pack tab.
...
Here you can follow the latest versions of this port and see what's new.
